...
## 📋 Features
- **Duplicate Detection**: Automatically find and remove duplicate files.
- **Smart Categorization**: Organize files into folders based on type and content.
- **Dark GUI**: Navigate the app easily with a modern and organized interface.
- **Supports 150+ Formats**: Works with a wide range of file types, including photos, documents, and media files.
- **Privacy-Focused**: No telemetry or tracking of your personal data.
- **Offline Functionality**: Use the app without needing an internet connection.

## 🖥️ System Requirements
- Operating System: Windows 10 or later
- RAM: 4 GB or more
- Disk Space: At least 100 MB free
- Python 3.7 or higher (bundled with the app)
...
3. **Run the Installer**: Locate the downloaded file on your computer. Double-click it to run the installer.

4. **Follow the Setup Wizard**: The setup wizard will guide you through the installation steps. Accept the license agreement and choose the destination folder for installation.

5. **Complete the Installation**: Once the installation is complete, click "Finish" to exit the setup wizard.

6. **Launch the Application**: You can open **file-organizer-renamer** from your Start Menu or desktop shortcut.

## 🌟 Using the Application
1. **Open the App**: Launch the application by double-clicking the icon.
  
2. **Choose a Folder**: Click on "Select Folder" to choose the directory you want to organize.

3. **Scan for Duplicates**: Click on the "Scan" button. The app will check for duplicate files.

4. **Review Results**: Once the scan is complete, review the detected duplicates. You can choose to delete or keep them.

5. **Organize Files**: Select files you want to categorize. Click on "Organize" to move files to their respective folders based on type.
